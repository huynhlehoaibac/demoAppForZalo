...
public class RefreshTokenExtractor implements TokenExtractor {
  ...
  public Authentication extract(HttpServletRequest request) {
    ...
    return new RefreshAuthenticationToken(rawAccessJwtToken);
  }
}
