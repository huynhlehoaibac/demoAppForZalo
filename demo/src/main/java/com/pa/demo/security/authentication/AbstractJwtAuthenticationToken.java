...
public class AbstractJwtAuthenticationToken extends AbstractAuthenticationToken {
  ...
  public AbstractJwtAuthenticationToken(RawJwtToken unsafeToken) {
    super(null);
    this.rawAccessToken = unsafeToken;
    this.setAuthenticated(false);
  }

  public AbstractJwtAuthenticationToken(AuthenticationUser authenticationUser,
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof AbstractJwtAuthenticationToken)) {
      return false;
    }

    AbstractJwtAuthenticationToken test = (AbstractJwtAuthenticationToken) obj;
